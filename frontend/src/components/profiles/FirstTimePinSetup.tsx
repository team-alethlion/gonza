...
export const FirstTimePinSetup: React.FC = () => {
  ...
  const handleSkip = () => {
    dismissFirstTimeSetup();
    toast.warning(
      "Remember to change your PIN from Settings → Profiles → Security",
    );
  };
      ...
      <DialogContent
        ...
        <DialogHeader>
          <div className="flex justify-center mb-6">
            <Image
              ...
              width={48}
              height={48}
              // h-12 is 48px, w-auto keeps the logo's original proportions
              className="h-12 w-auto animate-in fade-in slide-in-from-bottom-2 duration-700 object-contain"
              priority
            />
          </div>
          ...
          <DialogDescription className="text-center">
            ...
            <span className="font-mono font-bold">0000</span>. For security, we
            recommend setting a custom PIN now.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-2">
          <Button
            ...
            disabled={
              isSubmitting || newPin.length !== 4 || confirmPin.length !== 4
            }>
