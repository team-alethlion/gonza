        ...
        <div className="text-center space-y-8">
          <div className="flex justify-center mb-4">
            <Image
              src="/icon.png"
              alt="Gonza Logo"
              // Provide the original source dimensions here
              width={512}
              height={512}
              // className handles the responsive heights and animations
              className="h-24 w-auto md:h-32 animate-in fade-in slide-in-from-bottom-8 duration-1000 object-contain"
              priority
            />
          </div>
