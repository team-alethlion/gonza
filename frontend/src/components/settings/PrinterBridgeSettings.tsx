  ...
  const handleScanDevices = async () => {
    ...
    try {
      ...
      toast({
        title: "Scan failed",
        description:
          "Could not connect to Printer Bridge. Make sure it is installed and running.",
        variant: "destructive",
      });
    } finally {
      setIsScanning(false);
      ...
      <CardContent className="space-y-6">
        <div className="bg-muted/30 p-4 rounded-lg border border-dashed text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Download and install our bridge service to enable high-speed local
            printing.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://drive.google.com/drive/folders/1xWpU63y1tKVnTVF5ftNVyhL82oR_EjnG?usp=sharing",
                  "_blank",
                )
              }>
              <ExternalLink className="h-4 w-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  (updateSettings as any)({ printerPaperSize: value })
                }>
        ...
        <div className="space-y-4">
          ...
          {bridgeStatus === "offline" ? (
            <div className="space-y-3">
              ...
              <div className="text-xs space-y-2 p-3 bg-muted rounded-md border">
                ...
                <ol className="list-decimal ml-4 space-y-1">
                  <li>
                    Ensure the Printer Bridge app is open and shows
                    &ldquo;Server running on port 5000&ldquo;.
                  </li>
                  <li>
                    ...
                    manually. If it works there but not here, it&apos;s a
            ...
            <div className="text-sm text-muted-foreground text-center py-4 border rounded-md italic">
              No printers found. Make sure your printers are turned on and
