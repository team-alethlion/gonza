    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      <div className="text-center space-y-6 max-w-md">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900">Application Error</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
          ...
          <Button onClick={() => signOut({ callbackUrl: '/public/login' })} variant="ghost" className="gap-2 text-red-600 hover:text-red-700 hover:bg-red-50">
